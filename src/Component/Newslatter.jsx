...
export default function Newslatter() {
    ...
    function postData(e) {
        ...
        setshow(true)
        setmsg("Thanks to Subcribe our Newslatter Service !!!")
        } 
    }
    useEffect(()=>{
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-8 heading-section text-center mb-4 ftco-animate">
                        <h3 className="mb-4">Subcribe Our Newslatter Service</h3>
                        {
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="mb-3">
                                <button type='submit' className='btn btn-secondary w-100 p-2 rounded-0'>Subcribe</button>
                            </div>
                        </form>
                    </div>
                </div>

                            ...
                            <div className='w-50 p-3 border'>
                                {data.paymentstatus}
                                {
                                    data.paymentstatus !== "Done" ?
                                        <select name="paymentstatus" onChange={getData} className='from-control'>
                            ...
                            <div className='w-50 p-3 border'>
                                <p className='w-50'>{data.orderstatus}</p>
                                {
                                    data.orderstatus !== "Delivered" ?
                                        <select name="orderstatus" onChange={getData} className='from-control'>

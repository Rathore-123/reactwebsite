                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="ftco-footer-widget mb-4">
                                ...
                                <div className="block-23 mb-3">
                                    <ul>
                                        <li><span className="icon icon-map-marker"></span><span className="text">A-43, Ducat Noida, Sector 16, Noida U.P,India -201301</span></li>
                                        <li><Link to="#"><span className="icon icon-phone"></span><span className="text">9520647927</span></Link></li>
                                        <li><Link to="#"><span className="icon icon-envelope"></span><span className="text">ranjeetkumar95686824@gmail.com</span></Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

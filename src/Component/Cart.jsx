			...
			<section className="ftco-section ftco-cart">
				<div className="container">
									...
									<tbody>
										{
											carts.map((item, index) => {
												return <tr key={index} className="text-center">
													...
													<td><button onClick={() => deleteItem(item.id, "id")} className='' style={{ background: "none", width: "30px" }}><i className="icon ion-ios-trash"></i></button></td>
												</tr>
											})
										}
									</tbody>
					...
					<div className="row justify-content-start">
						...
						<div className="col-md-6 mt-2 cart-wrap ftco-animate">
